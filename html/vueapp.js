...
var params_descriptions = new Map([
	...
	//
	['SHOW_CAM', 'Показывать изображение с камер (1 - с первой, 2 - со второй, 3 - с обеих)'],
	...
	['DRAW', 'Показывать изображение. Предыдущие 4 опции действуют только при включенной этой'],
	//
