...
std::map<std::string, void*> config_pointers = {
	...
	//
	{ "USE_IMAGE_ROI",	&config_buf.USE_IMAGE_ROI },
	{ "IMAGE_ROI_X",	&config_buf.IMAGE_ROI_X },
	{ "IMAGE_ROI_Y",	&config_buf.IMAGE_ROI_Y },
	{ "IMAGE_ROI_W",	&config_buf.IMAGE_ROI_W },
	{ "IMAGE_ROI_H",	&config_buf.IMAGE_ROI_H },
	//
	...
	{ "AUTO_MIN_POINTS",	&config_buf.AUTO_MIN_POINTS },
	{ "MANUAL_MIN_POINTS",	&config_buf.MANUAL_MIN_POINTS },
	...
	{ "WEB_SHOW_DEBUG",		&config_buf.WEB_SHOW_DEBUG },
	{ "WEB_SHOW_IMAGE",		&config_buf.WEB_SHOW_IMAGE },
